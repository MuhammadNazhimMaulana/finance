                    ...
                    <form class="text-left" method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form">
                            <div id="email-field" class="field-wrapper input">
                                ...
                                <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email">
                            </div>
                            ...
                            <div class="d-sm-flex justify-content-between">
                                <div class="field-wrapper">
                                    <button type="submit" class="btn btn-primary">{{ __('Atur Ulang Kata Sandi') }}</button>
                                </div>
                            </div>
                        </div>
                    </form>
